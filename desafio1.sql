...
INSERT INTO SpotifyClone.users (usuario, idade, data_assinatura, id_plano)
VALUES
...
INSERT INTO SpotifyClone.seguidores (usuario_id, id_artista)
VALUES
  (1, 1),
  (1, 4),
  (1, 3),
...
INSERT INTO SpotifyClone.cancoes (cancao, duracao_cancao, album_id)
VALUES
  ('Soul For us', '00:03:33', 1),
  ('Reflections Of Magic', '00:03:18', 1),
  ('Dance With Her Own', '00:02:55', 1),
  ('Troubles Of My Inner Fire', '00:03:38', 2),
  ('Time Fireworks', '00:02:53', 2),
  ('Magic Circus', '00:02:25', 3),
  ('Honey, So Do I', '00:03:45', 3),
  ('Sweetie, Let`s Go Wild', '00:02:31', 3),
  ('She Knows', '00:04:06', 3),
  ('Fantasy For Me', '00:02:10', 4),
  ('Celebration Of More', '00:02:43', 4),
  ('Rock His Everything', '00:04:18', 4),
  ('Home Forever', '00:04:41', 4),
  ('Diamond Power', '00:04:01', 4),
  ('Let`s Be Silly', '00:02:02', 4),
  ('Thang Of Thunder', '00:04:00', 5),
  ('Words Of Her Life', '00:03:08', 5),
  ('Without My Streets', '00:03:55', 5),
  ('Need Of The Evening', '00:03:16', 6),
  ('History Of My Roses', '00:04:16', 6),
  ('Without My Love', '00:02:41', 6),
  ('Walking And Game', '00:02:05', 6),
  ('Young And Father', '00:03:28', 6),
  ('Finding My Traditions', '00:04:05', 7),
  ('Walking And Man', '00:04:35', 7),
  ('Hard And Time', '00:02:25', 7),
  ('Honey, I`m A Lone Wolf', '00:02:50', 7),
  ('She Thinks I Won`t Stay Tonight', '00:03:26', 8),
  ('He Heard You`re Bad For Me', '00:02:56', 8),
  ('He Hopes We Can`t Stay', '00:03:50', 8),
  ('I Know I Know', '00:02:58', 8),
  ('He`s Walking Away', '00:03:08', 9),
  ('He`s Trouble', '00:02:30', 9),
  ('I Heard I Want To Bo Alone', '00:02:00', 9),
  ('I Ride Alone', '00:02:51', 9),
  ('Honey', '00:01:31', 10),
  ('You Cheated On Me', '00:01:58', 10),
  ('Wouldn`t It Be Nice', '00:03:55', 10),
  ('Baby', '00:02:26', 10),
  ('You Make Me Feel So..', '00:01:38', 10);

INSERT INTO SpotifyClone.hst_reproducoes (usuario_id, data_reproducao, id_cancao)
VALUES
